...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(16)(module), __webpack_require__(1)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TimelineLite_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TimelineMax_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__CSSPlugin_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AttrPlugin_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__RoundPropsPlugin_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DirectionalRotationPlugin_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack_js__ = __webpack_require__(10);
...
.setClassToggle('#l1', 'transition_double').addTo(controller); // assign the scene to the controller
...
var tween = new _gsap.TimelineMax().add([_gsap.TweenMax.to("#hand_left", .5, { x: 0, opacity: 1 }), _gsap.TweenMax.to("#hand_right", .5, { x: 0, opacity: 1 }), _gsap.TweenMax.to($path, .2, { opacity: 1, delay: .5 }), _gsap.TweenMax.to($path, .5, { strokeDashoffset: 0, delay: .5 }), _gsap.TweenMax.to($pathMobile, .2, { opacity: 1, delay: .5 }), _gsap.TweenMax.to($pathMobile, .5, { strokeDashoffset: 0, delay: .5 })]);
...
new _scrollmagic2.default.Scene({
    ...
    var valueCounter = 1;
    var valueHands = 1;
    var progress = (e.progress * 100).toFixed();
    var progressCounter = (progress / 3.333333).toFixed();
    var progressHands = (progress / 5).toFixed();
...
var tween3 = new _gsap.TimelineMax().add([_gsap.TweenMax.to("#circle3", 1, { scale: 10 }), _gsap.TweenMax.to("#text3", .5, { opacity: 0 })]);
...
new _scrollmagic2.default.Scene({
    triggerElement: '#p4',
    triggerHook: 0
}).setClassToggle('#p3', 'hidden').addTo(controller);

var tween4 = new _gsap.TimelineMax().add([_gsap.TweenMax.to("#p4_text_1", .2, { opacity: 1, y: 0, delay: 0 }), _gsap.TweenMax.to("#p4_text_3", .2, { opacity: 1, y: 0, delay: .2 }), _gsap.TweenMax.to("#p4_text_1", .2, { opacity: 0, y: 50, delay: .5 }), _gsap.TweenMax.to("#p4_text_2", .2, { opacity: 1, y: 0, delay: .7 })]);
...
var tween5 = new _gsap.TimelineMax().add([_gsap.TweenMax.to("#t5_d", 1, { y: 0 })]);
...
// Навигация
var $body = $('body');
var $navNum = $('.jsNavNumber');
var $navLine = $('.jsNavLine');
new _scrollmagic2.default.Scene({
    triggerElement: '#ln_1',
    duration: $('#ln_1').height()
}).setClassToggle('#n_1', 'active').addTo(controller).on('enter', function (e) {
...
}).setClassToggle('#n_2', 'active').addTo(controller).on('enter', function (e) {
    $body.removeClass('theme-white');
...
}).setClassToggle('#n_3', 'active').addTo(controller).on('enter', function (e) {
...
}).setClassToggle('#n_4', 'active').addTo(controller).on('enter', function (e) {
    $body.removeClass('theme-white');
...
}).setClassToggle('#n_5', 'active').addTo(controller).on('enter', function (e) {
    $body.addClass('theme-white');
...
}).setClassToggle('#n_6', 'active').addTo(controller).on('enter', function (e) {
    $body.addClass('theme-white');
...
new _scrollmagic2.default.Scene({
    triggerElement: '#ln_6',
    duration: $('#ln_6').height()
}).setClassToggle('#scroll_button', 'up').addTo(controller);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack_js__ = __webpack_require__(10);
...
(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		factory(__webpack_require__(11), TweenMax, TimelineMax);
	} else {
		// Browser globals
